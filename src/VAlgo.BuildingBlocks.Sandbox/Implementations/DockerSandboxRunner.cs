...
namespace VAlgo.BuildingBlocks.Sandbox.Implementations
{
    public sealed class DockerSandboxRunner : ISandboxRunner
    {
        ...
        public async Task<CompileResult> CompileAsync(SandboxCompileRequest request, CancellationToken cancellationToken = default)
        {
