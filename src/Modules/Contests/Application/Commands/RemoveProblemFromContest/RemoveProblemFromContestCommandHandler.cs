...
{
    public sealed class RemoveProblemFromContestCommandHandler : IRequestHandler<RemoveProblemFromContestCommand, Unit>
    {
        private readonly IContestRepository _contestRepository;
        private readonly IUnitOfWork _unitOfWork;

        public RemoveProblemFromContestCommandHandler(IContestRepository contestRepository, IUnitOfWork unitOfWork)
        {
            _contestRepository = contestRepository;
            _unitOfWork = unitOfWork;
        }

        public async Task<Unit> Handle(RemoveProblemFromContestCommand request, CancellationToken cancellationToken)
        {
            ...
            contest.RemoveProblem(request.ProblemId);
