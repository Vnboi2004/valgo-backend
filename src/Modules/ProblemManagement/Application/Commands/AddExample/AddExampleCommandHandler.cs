...
{
    public sealed class AddExampleCommandHandler : IRequestHandler<AddExampleCommand, Unit>
    {
        private readonly IProblemRepository _problemRepository;
        private readonly IUnitOfWork _unitOfWork;

        public AddExampleCommandHandler(IProblemRepository problemRepository, IUnitOfWork unitOfWork)
        {
