...
{
    public sealed class ArchiveProblemCommandHandler : IRequestHandler<ArchiveProblemCommand, Unit>
    {
        private readonly IProblemRepository _problemRepository;
        private readonly IClock _clock;
        private readonly IUnitOfWork _unitOfWork;

        public ArchiveProblemCommandHandler(
        ...
        public async Task<Unit> Handle(ArchiveProblemCommand request, CancellationToken cancellationToken)
        {
