...
namespace VAlgo.Modules.UserProfile.Application.Queries.GetUserStats
{
    public sealed class GetUserStatsQueryHandler : IRequestHandler<GetUserStatsQuery, UserStatsDto>
    {
        ...
        public GetUserStatsQueryHandler(IUserIdentityReadService userIdentityReadService, IUserProfileReadService userProfileReadService)
        {
        ...
        public async Task<UserStatsDto> Handle(GetUserStatsQuery request, CancellationToken cancellationToken)
        {
            ...
            return await _userProfileReadService.GetUserStatsAsync(userId, cancellationToken);
        }
    }
}